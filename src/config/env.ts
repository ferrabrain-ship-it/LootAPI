...
export const env = {
  ...
  enableProtocolIndexer: process.env.ENABLE_PROTOCOL_INDEXER === 'true',
  allowLiveProtocolFallbacks: process.env.ALLOW_LIVE_PROTOCOL_FALLBACKS === 'true',
  ...
  treasuryAgentSnapshotSyncIntervalMs: toNumber(process.env.TREASURY_AGENT_SNAPSHOT_SYNC_INTERVAL_MS, 600000),
  ...
  newStackScanStartBlock: toBigInt(process.env.NEW_STACK_SCAN_START_BLOCK, 45791564n),
