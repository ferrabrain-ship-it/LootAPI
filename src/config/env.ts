...
export const env = {
  ...
  discordPriceCommandRenderTimeoutMs: Number(process.env.DISCORD_PRICE_COMMAND_RENDER_TIMEOUT_MS || '14000'),
  ...
  discordMetricsPollIntervalMs: Number(process.env.DISCORD_METRIC_BOTS_POLL_INTERVAL_MS || '120000'),
